...
if("FALSE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /home/redbird-general/2018_AAV/dev_ws/src/localization)
  set(localization_DEVEL_PREFIX /home/redbird-general/2018_AAV/dev_ws/devel/.private/localization)
  ...
  set(localization_INSTALL_PREFIX /home/redbird-general/2018_AAV/dev_ws/install)
...
if(NOT "include;/usr/local/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/redbird-general/2018_AAV/dev_ws/install/${idir}'.  ${_report}")
    endif()
    _list_append_unique(localization_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "localization;Camera;Communication;Robot;/usr/local/lib/libboost_system.so;/usr/local/lib/libboost_filesystem.so;/usr/local/lib/libboost_thread.so;/usr/local/lib/libboost_chrono.so;/usr/local/lib/libboost_date_time.so;/usr/local/lib/libboost_atomic.so;/usr/lib/x86_64-linux-gnu/libpthread.so;/usr/lib/x86_64-linux-gnu/libSM.so;/usr/lib/x86_64-linux-gnu/libICE.so;/usr/lib/x86_64-linux-gnu/libX11.so;/usr/lib/x86_64-linux-gnu/libXext.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/redbird-general/2018_AAV/dev_ws/install/lib;/home/redbird-general/2018_AAV/dev_ws/devel/lib;/opt/ros/kinetic/lib)
